...
### null和undefined区别
1. null定义的变量指向一个对象,undefined定义变量未赋值
2. undefined+0=NaN
3. null+1=0(null自动转为0)
4. if语句中都是false
...
```
2. SharedArrayBuffer 可以在多个线程之间共享数据
3. Service Workers用于在 Web 应用程序的网络请求和响应之间加入一个中间层
